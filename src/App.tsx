  ...
  return (
    <>
      ...
      <div className="bg-custom">
        <div className="pt-16">
          <div className="max-w-[580px] flex items-center justify-between m-auto">
            <h1 className="text-white text-4xl font-semibold">Snapshot</h1>
          ...
          <div className="basis-[57%] rounded-[32px] border-2 border-[#077858] bg-[#282828B2] p-8">
            ...
            <div className="pt-7">
              ...
              <p className="text-white max-w-[520px] my-3 font-medium">
                ...
                <a href="/" className="text-[#18C38D] text-lg font-semibold">
                  AirdropTool{" "}
                </a>
              </p>
            </div>
